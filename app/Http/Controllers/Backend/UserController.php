...
class UserController extends Controller
{
  ...
  */
  public function index()
  {
    ...
    return view("backend.$module_path.index_datatable",compact(
      'module_title',
      'module_name',
      "$module_name",
      'module_path',
  ...
  */
  public function show($id)
  {
    ...
    return view("backend.$module_name.show",compact(
      'module_title',
      'module_name',
      'module_path',
      'module_icon',
  ...
  */
  public function profile(Request $request, $id)
  {
    ...
    return view("backend.$module_name.profile", compact(
      'module_name',
      "$module_name_singular",
      'module_icon',
      'module_action',
  ...
  */
  public function profileEdit($id)
  {
    ...
    return view("backend.$module_name.profileEdit",compact(
      'module_title',
      'module_name',
      'module_path',
      'module_icon',
  ...
  */
  public function changeProfilePasswordUpdate(Request $request, $id)
  {
    ...
    return redirect()->route("backend.users.profile",$id);
  ...
  */
  ...
  {
    $module_name = $this->module_name;
    $module_title = "Change User Password";
    $module_name_singular = str_singular($this->module_name);
    ...
    // return redirect()->route('backend.users.profile', Auth::user()->id);
  ...
  */
  public function update(Request $request, $id)
  {
    ...
    if ($request->file('avatar')) {
      ...
      if(File::exists('assets/images/users/'.$$module_name_singular->avatar)){
        unlink('assets/images/users/'.$$module_name_singular->avatar);
      }
    ...
    $data_array['avatar'] = isset($fileName) ? $fileName : $$module_name_singular->avatar;
