        ...
        <div class="table-responsive">
          <table class="table table-hover">
            <tr>
              ...
              <td><img src="{{ asset('assets/images/users/'.$$module_name_singular->avatar) }}" class="user-profile-image img-fluid img-thumbnail" style="max-height:200px; max-width:200px;" /></td>
            </tr>
