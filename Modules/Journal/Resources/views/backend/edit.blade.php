  ...
  <div class="card-body">
    ...
    <div class="row mt-4">
      <div class="col">
        ...
        {{ html()->modelForm($journal, 'PATCH', route("backend.$module_name.update", $journal))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}

        @include ("journal::backend.edit_form")
