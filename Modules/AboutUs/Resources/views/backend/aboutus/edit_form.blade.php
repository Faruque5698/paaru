...
<div class="row">
  ...
  <div class="col-8">
    <div class="form-group">
      ...
      @php
      $field_name = 'about_bls';
      $field_lable = "About Paaru";
      $field_placeholder = $field_lable;
      $required = "required";
      @endphp
  ...
  <div class="col-4">
    ...
    <div class="row">
      <div class="col-12">
        <div class="form-group">
          <img id="show" src="{{ $about_us->image ? asset('assets/images/aboutus/'.$about_us->image) : 'http://placehold.it/800x480' }}" alt="your image" width="250" height="250"/>
        </div>
      </div>
    </div>
