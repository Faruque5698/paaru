  ...
  <div class="card-body">
    ...
    <div class="row mt-4">
      <div class="col">
        ...
        {{ html()->modelForm($notice, 'PATCH', route('backend.notice.update', $notice))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
              <iframe src="{{ $notice->pdf_file ? asset('assets/pdf/notices/'.$notice->pdf_file) : 'http://placehold.it/180' }}" width="180" height="180" id="show"></iframe>
