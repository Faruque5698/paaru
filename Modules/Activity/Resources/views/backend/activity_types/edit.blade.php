  ...
  <div class="card-body">
    ...
    <div class="row mt-4">
      <div class="col">
        ...
        {{ html()->modelForm($type, 'PATCH', route("backend.$route_path.update", $type->id))->class('form-horizontal')->open() }}
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              @php
              $field_name = 'name';
              $field_lable = 'Activity Type Name (English)';
          ...
          <div class="col-6">
            <div class="form-group">
              @php
              $field_name = 'name_bn';
              $field_lable = 'Activity Type Name (Bangla)';
              $field_placeholder = $field_lable;
              $required = "required";
              @endphp
