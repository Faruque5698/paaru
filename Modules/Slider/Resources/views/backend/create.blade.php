  ...
  <div class="card-body">
    ...
    <div class="row mt-4">
      <div class="col">
        ...
        <form class="" action="{{ route("backend.$module_name.store") }}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-6">
              ...
              <div class="col-12">
                <div class="form-group">
                  <img id="show" src="http://placehold.it/1920x750/0000FF/808080" alt="your image" width="490" height="200"/>
                </div>
              </div>
