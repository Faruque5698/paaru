    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Alumni Members</li>
            </ol>
        </nav>
    </div>
</section>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="content-wrap committee-list">
          <div class="card">
            <h5 class="card-header">List of Alumni Members</h5>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    @foreach($alumni_members as $key=> $alumni_member)
                    <tr>
                      <td> {{ ++$key }} </td>
                      <td class="members-name-td">
                        <a href="#" id="member" data-toggle="modal" data-id="{{ $alumni_member->id }}" data-target=""> {{ $alumni_member->name }} </a>
                      </td>
                      <td>{{ $alumni_member->bachelor_year }}</td>
                      <td>{{ $alumni_member->designation }}</td>
                      <td>{{ $alumni_member->m_phone }}</td>
                      <td class="text-center"><img src="{{ $alumni_member->image ? asset('assets/images/members/'.$alumni_member->image) : asset('assets/images/president.png') }}" alt="Member's Image"></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
