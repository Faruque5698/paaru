...
@section('title', $member_type->name)
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ $member_type->name}}</li>
      </ol>
    </nav>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="content-wrap committee-list">
          <div class="card">
            <h5 class="card-header">List of {{ $member_type->name}}</h5>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="members-name-td">
                        <a href="#" id="member" data-toggle="modal" data-id="{{ $member->id }}" data-target=""> {{
                          $member->name }} </a>
                      </td>
