    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Life Members</li>
            </ol>
        </nav>
    </div>
</section>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="content-wrap committee-list">
          <div class="card">
            <h5 class="card-header">List of Life Members</h5>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    @foreach($life_time_members as $key=> $life_time_member)
                    <tr>
                      <td> {{ ++$key }} </td>
                      <td class="members-name-td">
                        <a href="#" id="member" data-toggle="modal" data-id="{{ $life_time_member->id }}" data-target=""> {{ $life_time_member->name }} </a>
                      </td>
                      <td>{{ $life_time_member->bachelor_year }}</td>
                      <td>{{ $life_time_member->designation }}</td>
                      <td>{{ $life_time_member->m_phone }}</td>
                      <td class="text-center"><img src="{{ $life_time_member->image ? asset('assets/images/members/'.$life_time_member->image) : asset('assets/images/president.png') }}" alt="Member's Image"></td>
                    </tr>
