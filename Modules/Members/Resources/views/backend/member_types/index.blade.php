    ...
    <div class="row">
      ...
      <div class="col-4">
        <div class="float-right">
          <a href="{{ route("backend.member_types.create")}}" class="btn btn-success m-1 btn-sm" data-toggle="tooltip" title="Create New"><i class="fas fa-plus-circle"></i> Create</a>
        </div>
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ route("backend.member_types.edit", $type->id) }}" class="btn btn-success btn-sm" title="Edit">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <form action="{{ route("backend.member_types.unpublished", $type->id) }}" method="POST">
                      {{ csrf_field() }}
                      {{ method_field('PUT') }}
            ...
            <div class="modal fade" id="publishModal{{$type->id}}">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <form action="{{ route("backend.member_types.published", $type->id) }}" method="POST">
                      {{ csrf_field() }}
                      {{ method_field('PUT') }}
                      <button type="submit" class="btn btn-danger">Yes</button>
                      <button type="button" class="btn btn-primary" data-dismiss="modal">No</button>
            ...
            <div id="deleteModal{{$type->id}}" class="modal fade">
              <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <form action="{{ route("backend.member_types.destroy", $type->id) }}" method="POST">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
            ...
            <!-- View Modal -->
            <div class="modal fade" id="viewModal{{$type->id}}">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
