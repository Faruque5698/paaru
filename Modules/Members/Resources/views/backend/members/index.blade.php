            ...
            <tr>
              ...
              <td class="text-center">
                <img
                  ...
                  alt="Member's Image" class="img-fluid img-thumbnail" style="max-width:100px;">
              </td>

              <td>

                @if($member->publication_status == 1)
                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#unpublishModal{{$member->id}}"
                  title="Unpublished">
                  <span class="fas fa-arrow-down"></span>
                </a>
                <a href="{{ route('backend.members.print_member',$member)}}" class="btn btn-success btn-sm"
                  title="Print Form">
                  <span class="fas fa-print"></span>
                </a>
                @else
                <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#publishModal{{$member->id}}"
                  title="Published">
                  <span class="fas fa-arrow-up"></span>
                </a>
                @endif

                <a href="#" class="btn btn-primary btn-sm" title="View" data-toggle="modal" data-target=""
                  data-id="{{ $member->id }}" id="member">
                  <span class="fas fa-eye"></span>
                </a>

                <a href='{{ route("backend.$module_name.edit", $member)}}' class="btn btn-success btn-sm" title="Edit">
                  <span class="fas fa-edit"></span>
                </a>

                <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$member->id}}"
                  title="Delete">
  ...
  $(document).on('click', '#member', function(e){
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // $("#member_image").attr("src","http://192.168.0.200/paaru/assets/images/members/"+data.image);
        if (member_image == "") {
        ...
        $("#no_of_daughter").html(data.no_of_daughter)
        $("#no_of_son").html(data.no_of_son)
