    ...
    <div class="card-body">
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="{{ $module_icon }}"></i> {{ $module_title }} <small class="text-muted">{{ $module_action
                        }}</small>
                </h4>
        ...
        <div class="row mt-4">
            <div class="col">
                ...
                {{ html()->form('POST', route("backend.$module_name.store"))->class('form')->attribute('enctype',
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            {{ html()->button($text = "<i class='fas fa-save'></i> " . ucfirst('Save') . "", $type =
