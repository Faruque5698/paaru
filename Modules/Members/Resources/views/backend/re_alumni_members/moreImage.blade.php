...
<li class="breadcrumb-item"><a href='{!!route("backend.renowned_alumni_members.index")!!}'><i class="{{ $module_icon }}"></i> {{ $module_title }}</a></li>
...
$("#image-file").fileinput({
  theme: 'fa',
  uploadUrl: "{{route('backend.re_image.upload')}}",
  uploadExtraData: function() {
    return {
      _token: "{{ csrf_token() }}",
      renownedAlumniMembersMoreImage: "{{$re_alumni_members->id}}",
    };
  },
