  ...
  <div class="card-body">
    ...
    <div class="row mt-4">
      <div class="col">
        ...
        {{ html()->modelForm($type, 'PATCH', route("backend.$module_path.update", $type->id))->class('form-horizontal')->open() }}
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="float-right">
              <div class="form-group">
                  <a type="button" class="btn btn-warning" href="{{ route('backend.committee_types.index') }}"><i class="fas fa-reply"></i> Cancel</a>
              </div>
            </div>
          </div>
        </div>
