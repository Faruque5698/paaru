...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">Select Committee</h5>
...
$(document).ready(function(){
  ...
  var advisory_committee = {!! json_encode($advisory_committee->toArray()) !!};

  var committee_id = advisory_committee.id;
  ...
  $(document).on('click', '#submit', function(e){
    ...
    $.ajax({
      url: "{{ route('backend.advisory_committee.update_advisory_committee') }}",
      method: 'POST',
      ...
      success: function(data) {
        ...
        if(!$.trim(data)){
          ...
          window.location.replace('/admin/advisory_committee');
        }
