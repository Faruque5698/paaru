        ...
        <table id="datatable" class="table table-bordered table-hover table-responsive-sm text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $message->phone }}</td>
              <td>{{ $message->email }}</td>
              <td>{!! str_limit(strip_tags($message->message), 30) !!}</td>
              <td>

                <a href="#" class="btn btn-primary btn-sm" title="View" data-toggle="modal" data-target="#viewModal{{$message->id}}">
                  <span class="fas fa-eye"></span>
                </a>
                <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$message->id}}" title="Delete">
