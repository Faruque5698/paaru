...
<div class="row">
  ...
  <div class="col-4">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="form-group">
          <img id="show" src="http://placehold.it/800x480/0000FF/808080" alt="your image" width="180" height="180"/>
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="form-group">
          ...
          <div class="checkbox">
            {{
              html()->checkbox($field_name)->id("ticket_book")
            }}
          </div>
