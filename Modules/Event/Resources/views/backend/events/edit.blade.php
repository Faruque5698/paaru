...
<li class="breadcrumb-item"><a href='{!!route("backend.$route_path.index")!!}'><i class="{{ $module_icon }}"></i> {{
    $module_title }}</a></li>
  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-4">
        <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
          <a href='{{ route("backend.$route_path.index") }}' class="btn btn-secondary btn-sm ml-1" data-toggle="tooltip"
    ...
    <div class="row mt-4">
      <div class="col">
        ...
        {{ html()->modelForm($event, 'PATCH', route("backend.$route_path.update", $event))->attribute('enctype',
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="float-right">
              <div class="form-group">
                <a type="button" class="btn btn-warning" href='{{ route("backend.$route_path.index") }}'><i
