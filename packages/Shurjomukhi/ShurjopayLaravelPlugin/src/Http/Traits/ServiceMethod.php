 ...
 * Date: 05-Nov-2022
 *
 * This is a trait named 'ServiceMethod' which holds few services method for 'Shurjopay.php' controller's
 * methods.Inside this trait you will find :-
 *         * prepareCurlRequest() -> used for HTTP API request.
 *              * validateInput() -> used for validating input request.
 *  * prepareTransactionPayload() -> used for preparing transaction payload with important data.
 *                 *  createLog() -> used for creating log message into 'storage/logs/shurjopay-plugin.log' .
 * By using all service methods, code repeatation is reduced inside 'Shurjopay.php' controller.
 * By separating all service methods into a single trait , length of code is reduced in controller.
*/
